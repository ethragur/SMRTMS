...
public class UserRecord extends TableRecordImpl<UserRecord> implements Record8<String, String, String, String, Double, Double, String, Byte> {

	private static final long serialVersionUID = -366435382;
	 ...
	 */
	@Override
	public UserRecord values(String value1, String value2, String value3, String value4, Double value5, Double value6, String value7, Byte value8) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public UserRecord(String id, String username, String email, String password, Double longitude, Double latitude, String avatar, Byte isonline) {
		super(User.USER);
